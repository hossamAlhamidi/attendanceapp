  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
        ...
        if(isSameTime){
          ...
          for(let i = 0 ; i<values.days.length-1 ; i++){
            obj.time += `"${values.days[i]}":"${values[`${values.days[i]}_from`]}-${values[`${values.days[i]}_to`]}",`
           }
           obj.time += `"${values.days[values.days.length-1]}":"${values[`${values.days[values.days.length-1]}_from`]}-${values[`${values.days[values.days.length-1]}_to`]}"`
          obj.time = `{${obj.time}}`
    ...
    <Fragment>
     ...
     <Text>{JSON.stringify(formik.errors)}</Text>
      ...
      <Card py={10} px={5} my={10}>
        ...
        {
            isSameTime?<SimpleGrid columns={[1, 2]} spacing={10}>
          <Box>
      ...
      <Stack direction='row'>
         <Box textAlign={'center'}>
         <Text>Sun</Text>
        <Radio   name={'tutorial_day'} onChange={formik.handleChange} value='sunday'></Radio>
         </Box>
         <Box textAlign={'center'}>
         <Text>Mon</Text>
        <Radio   name={'tutorial_day'} onChange={formik.handleChange} value='monday'></Radio>
         </Box>
         <Box textAlign={'center'}>
         <Text>Tue</Text>
        <Radio   name={'tutorial_day'} onChange={formik.handleChange} value='tuesday'></Radio>
         </Box>
         <Box textAlign={'center'}>
         <Text>Wed</Text>
        <Radio   name={'tutorial_day'} onChange={formik.handleChange} value='wednesday'></Radio>
         </Box>
         <Box textAlign={'center'}>
         <Text>Thu</Text>
        <Radio   name={'tutorial_day'} onChange={formik.handleChange} value='thursday'></Radio>
         </Box>
      </Stack>
    </RadioGroup>
      </Box>
      ...
      <Stack direction='row'>
         <Box textAlign={'center'}>
         <Text>Sun</Text>
        <Radio   name={'lab_day'} onChange={formik.handleChange} value='sunday'></Radio>
         </Box>
         <Box textAlign={'center'}>
         <Text>Mon</Text>
        <Radio   name={'lab_day'} onChange={formik.handleChange} value='monday'></Radio>
         </Box>
         <Box textAlign={'center'}>
         <Text>Tue</Text>
        <Radio   name={'lab_day'} onChange={formik.handleChange} value='tuesday'></Radio>
         </Box>
         <Box textAlign={'center'}>
         <Text>Wed</Text>
        <Radio   name={'lab_day'} onChange={formik.handleChange} value='wednesday'></Radio>
         </Box>
         <Box textAlign={'center'}>
         <Text>Thu</Text>
        <Radio   name={'lab_day'} onChange={formik.handleChange} value='thursday'></Radio>
         </Box>
      </Stack>
    </RadioGroup>
      </Box>
